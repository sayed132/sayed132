...
<ul> 
<li><strong>JavaScript (ES6+)</strong> – Writing clean, modern, and maintainable code</li> 
<li><strong>TypeScript</strong> – Type-safe, scalable development</li> 
<li><strong>Node.js & Express.js</strong> – Backend architecture, API design, server-side logic</li> 
<li><strong>MongoDB with Prisma</strong> – Schema-based data modeling, efficient queries, and type-safe database access</li>
<li><strong>React</strong> – Building interactive and reusable frontend components</li> 
<li><strong>Firebase</strong> – Authentication, hosting, and cloud services</li> 
<li><strong>JWT</strong> – Secure, role-based access control</li> 
<li><strong>HTML5, CSS3, Tailwind CSS</strong> – Responsive and accessible UI design</li> 
<li><strong>Git & GitHub</strong> – Version control, collaborative workflows, and CI/CD practices</li> 

</ul> <p> I am eager to grow as a **Full-Stack Engineer with a backend specialization**, contributing to impactful projects and collaborating with experienced teams in fast-paced environments. 

</p>

- 📫 How to reach me: **rafsansayed132@gmail.com**
